...
This add-on version installs `toposync-streaming==0.7.8`. The add-on version can differ from the Python package version because Home Assistant tracks the container package separately.
