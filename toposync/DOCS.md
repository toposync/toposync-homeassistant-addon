...
The add-on installs `toposync-streaming==0.7.6`. The add-on version can differ from the Python package version because Home Assistant tracks add-on releases separately.
